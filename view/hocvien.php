...
<div class="page ">
                    ...
                    <div class="container page__container">
                        ...
                        <div class="card-columns">
                            ...
                            //var_dump($mh);
                            //echo 'giá trị ';echo  $_SESSION['idnganh'];
                                        ...
                                        <div class="card-header">
                                            <div class="media">
                                                ...
                                                <div class="card-footer bg-white">
                                                    <a href="index.php?act=dkkhhv&idsubject='.$idsubject.'&iduser='.$iduser.'" class="btn btn-primary btn-sm">Tham gia khoá học<i class="material-icons btn__icon--right">play_circle_outline</i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>';
