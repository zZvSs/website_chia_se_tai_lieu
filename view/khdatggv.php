                                        ...
                                        <div class="card">
                                                    ...
                                                    <div class="flex"
                                                        ...
                                                        <div class="d-flex align-items-end">
                                                            ...
                                                            <div class="text-center">
                                                                <a href="index.php?act=laytlmhgv&idsubject='.$idsubject.'" class="btn btn-sm btn-white" >Tài liệu</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card__options dropdown right-0 pr-2">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="index.php?act=huykhgv&idsubject='.$idsubject.'&iduser='.$iduser.'" class="dropdown-item text-danger" type="button">Huỷ khoá học</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
