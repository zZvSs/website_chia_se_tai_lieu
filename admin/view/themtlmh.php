...
<div class="row">
    ...
    <div class="col">
        <div class="card mb-3">
            ...
            <form role="form" action="index.php?act=themtlmh" method="POST">
                <div class="card-header uppercase">
                    <div class="caption">
                        <i class="ti-briefcase"></i> Thêm tài liệu môn học
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <button type="submit" name="themtlmh" class="btn btn-outline-primary "><i class="ti-pencil-alt"></i> Thêm</button>
            </form>
        </div>
    </div>
    <!-- EOF General Form -->
