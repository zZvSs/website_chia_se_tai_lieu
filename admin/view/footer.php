...
<div class="footer">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="message-group d-flex flex-row mb-3">
                                            <a href="#"><img src="img/profile/profile-01.jpg" class="rounded"
                                                    alt="image"></a>
                                        ...
                                        <div class="message-group d-flex flex-row mb-3">
                                            <a href="#"><img src="img/profile/profile-03.jpg" class="rounded"
                                                    alt="image"></a>
                                            <div class="message-item">
                                        ...
                                        <div class="message-group d-flex flex-row mb-3">
                                            <a href="#"><img src="img/profile/profile-02.jpg" class="rounded"
                                                    alt="image"></a>
                                            <div class="message-item">
                                        ...
                                        <div class="message-group d-flex flex-row">
                                            <a href="#"><img src="img/profile/profile-05.jpg" class="rounded"
                                                    alt="image"></a>
                                            <div class="message-item">
    ...
    <script src="scripts/siqtheme.js"></script>
    <script src="scripts/pages/dashboard1.js"></script>
</body>
